...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            runtime::homeserver_action_orchestration,
            runtime::homeserver_run_agent_runtime_once,
            runtime::homeserver_run_action_orchestration_once,
            runtime::homeserver_cancel_agent_runtime_plan,
            runtime::homeserver_rollback_supervised_action,

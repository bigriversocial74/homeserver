-- Phase 5B multi-cloud connection registry.
-- The legacy singleton tables are created defensively so this additive migration
-- is safe in focused tests, recovery databases, and normal ordered startup.
